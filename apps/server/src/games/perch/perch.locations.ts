 ...
 */
import type { LocationEffect } from './perch.state';
...
export interface PerchLocationDef {
  ...
  /** Nº de ninhos (cada um = +1 para quem ocupa). */
  nests?: number;
  /** Efeito especial, se houver (Fase D). */
...
export const PERCH_LOCATIONS: readonly PerchLocationDef[] = [
  ...
  { id: 'ash', name: 'Grande Freixo', emoji: '🌳', points: [4, 2, 1], nests: 1 },
  ...
  { id: 'oak', name: 'Poderoso Carvalho', emoji: '🌳', points: [6, 4, 0], nests: 1 },
  { id: 'birch', name: 'Bétulas Descascando', emoji: '🌳', points: [4, 3, 2] },
  {
    id: 'powerlines',
    name: 'Fios Balançando',
    emoji: '⚡',
    points: [3, 3, 0],
    effect: { kind: 'upkeepSendToFountain', n: 1 },
  },
  { id: 'rookery', name: 'A Colônia', emoji: '🪺', points: [2, 2, 2], nests: 2 },
  ...
  {
    id: 'feeder',
    name: 'Comedouro Farto',
    emoji: '🌰',
    points: [3, 2, 1],
    effect: { kind: 'migrateAddBirds', n: 1 },
  },
];
